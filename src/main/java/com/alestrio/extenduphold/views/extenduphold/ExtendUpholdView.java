package com.alestrio.extenduphold.views.extenduphold;
...
@PageTitle("ExtendUphold")
@CssImport(value = "./styles/views/extenduphold/extend-uphold-view.css", include = "lumo-badge")
@JsModule("@vaadin/vaadin-lumo-styles/badge.js")
@RouteAlias(value = "", layout = MainView.class)
public class ExtendUpholdView extends Div implements AfterNavigationObserver {
    ...
    public ExtendUpholdView() {
        setId("extend-uphold-view");
